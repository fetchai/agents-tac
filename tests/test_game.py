...
class TestGameConfiguration:
    ...
    def test_agent_nb_and_public_keys_nonmatch_raises_exception(self):
        ...
        with pytest.raises(
            AssertionError, match="There must be one public key for each agent."
        ):
            GameConfiguration(
                "1",
                3,
    ...
    def test_good_nb_and_public_keys_nonmatch_raises_exception(self):
        ...
        with pytest.raises(
            AssertionError, match="There must be one public key for each good."
        ):
            GameConfiguration(
                "1",
                2,
...
class TestGameIntitialization:
    ...
    def test_negative_money_raises_exception(self):
        ...
        endowments = [[1, 1, 4], [1, 5, 1], [6, 1, 2]]
        utility_params = [[0.3, 0.4, 0.3], [0.1, 0.8, 0.1], [0.3, 0.2, 0.5]]
    ...
    def test_negative_endowments_raises_exception(self):
        ...
        eq_money_holdings = [20.0, 20.0, 20.0]
        with pytest.raises(
            AssertionError, match="Endowments must be strictly positive."
        ):
            GameInitialization(
                initial_money_amounts,
                endowments,
    ...
    def test_negative_utilities_raises_exception(self):
        ...
        eq_money_holdings = [20.0, 20.0, 20.0]
        with pytest.raises(
            AssertionError, match="UtilityParams must be strictly positive."
        ):
            GameInitialization(
                initial_money_amounts,
                endowments,
    ...
    def test_from_dict(self):
        ...
        actual_game_initialization = GameInitialization.from_dict(
            expected_game_initialization.to_dict()
        )
...
class TestGame:
    ...
    def test_transaction_invalid_if_buyer_does_not_have_enough_money(self):
        ...
        utility_params = [[20.0, 40.0, 40.0], [10.0, 50.0, 40.0], [40.0, 30.0, 30.0]]
        eq_prices = [1.0, 1.0, 4.0]
        eq_good_holdings = [[1.0, 1.0, 4.0], [1.0, 5.0, 1.0], [6.0, 1.0, 2.0]]
        eq_money_holdings = [20.0, 20.0, 20.0]

        game_configuration = GameConfiguration(
            "1", nb_agents, nb_goods, tx_fee, agent_pbk_to_name, good_pbk_to_name
        )
        game_initialization = GameInitialization(
            money_amounts,
            endowments,
        ...
        invalid_transaction = Transaction(
            tx_id, is_sender_buyer, buyer_pbk, amount, quantities_by_good, seller_pbk
        )
    ...
    def test_get_game_data_from_agent_label(self):
        ...
        expected_agent_state_0 = AgentState(
            money_amounts[0], endowments[0], utility_params[0]
        )
        expected_agent_state_1 = AgentState(
            money_amounts[1], endowments[1], utility_params[1]
        )
    ...
    def test_to_dict(self):
        ...
        transaction_1 = Transaction(
            tx_id, True, counterparty_pbk, 10, {"tac_good_0_pbk": 1}, sender_pbk
        )
        transaction_2 = Transaction(
            tx_id, False, counterparty_pbk, 10, {"tac_good_0_pbk": 1}, sender_pbk
        )
        ...
        expected_game_dict = {
            ...
            "transactions": [transaction_1.to_dict(), transaction_2.to_dict()],
        }
    ...
    def test_from_dict(self):
        ...
        counterparty_pbk = "tac_agent_1_pbk"
        transaction_1 = Transaction(
            tx_id, True, counterparty_pbk, 10.0, {"tac_good_0_pbk": 1}, sender_pbk
        )
        transaction_2 = Transaction(
            tx_id, False, counterparty_pbk, 10.0, {"tac_good_0_pbk": 1}, sender_pbk
        )
