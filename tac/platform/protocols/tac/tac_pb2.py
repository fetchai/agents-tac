...
_TACCONTROLLER_ERROR_ERRORCODE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="AGENT_PBK_ALREADY_REGISTERED",
            index=2,
            number=2,
            options=None,
            type=None,
...
_TACCONTROLLER_GAMEDATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="money",
            full_name="fetch.oef.pb.TACController.GameData.money",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="endowment",
            full_name="fetch.oef.pb.TACController.GameData.endowment",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="utility_params",
            full_name="fetch.oef.pb.TACController.GameData.utility_params",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="nb_agents",
            full_name="fetch.oef.pb.TACController.GameData.nb_agents",
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="nb_goods",
            full_name="fetch.oef.pb.TACController.GameData.nb_goods",
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="agent_pbk_to_name",
            full_name="fetch.oef.pb.TACController.GameData.agent_pbk_to_name",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="good_pbk_to_name",
            full_name="fetch.oef.pb.TACController.GameData.good_pbk_to_name",
            index=7,
            number=8,
            type=11,
            cpp_type=10,
...
_TACCONTROLLER_TRANSACTIONCONFIRMATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="transaction_id",
            full_name="fetch.oef.pb.TACController.TransactionConfirmation.transaction_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_TACCONTROLLER_STATEUPDATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="initial_state",
            full_name="fetch.oef.pb.TACController.StateUpdate.initial_state",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_TACCONTROLLER_ERROR = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="error_msg",
            full_name="fetch.oef.pb.TACController.Error.error_msg",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="details",
            full_name="fetch.oef.pb.TACController.Error.details",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_TACAGENT_TRANSACTION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="transaction_id",
            full_name="fetch.oef.pb.TACAgent.Transaction.transaction_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="is_sender_buyer",
            full_name="fetch.oef.pb.TACAgent.Transaction.is_sender_buyer",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="counterparty",
            full_name="fetch.oef.pb.TACAgent.Transaction.counterparty",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="amount",
            full_name="fetch.oef.pb.TACAgent.Transaction.amount",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="quantities",
            full_name="fetch.oef.pb.TACAgent.Transaction.quantities",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
