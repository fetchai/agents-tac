...
import wtforms
from wtforms import Form, StringField, IntegerField, FileField, DateTimeField, widgets, FloatField
...
class SandboxForm(Form):
    ...
    tx_fee = FloatField("Transaction fee", default=0.1, widget=widgets.Input(input_type="number"), validators=[wtforms.validators.NumberRange(min=0, message="Must be non-negative")],)
